  ...
  const handleDetection = async () => {
    ...
    try {
      ...
      if (response.isSuccess && response.infos) {
        ...
        const errorMessage = response.messages?.[0]?.description || t.insulatorDetectionFailed
                                ...
                                <Alert
                                  ...
                                  description={
                                    <div>
                                      ...
                                      {(error.includes('识别失败') || error.includes('No defects detected') || error === t.noDefectDetected) && (
                                        <div style={{ 
                                          padding: '8px 12px', 
